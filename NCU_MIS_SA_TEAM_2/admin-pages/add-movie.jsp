...
<body>
	<div class="main">
	<h1>新增電影</h1>
	<form action="/NCU_MIS_SA/admin-pages/add-movie" method="post" id="form" enctype="multipart/form-data">
		<div class="my-row">
			<div class="my-column">
				<label for="title">電影名稱：</label>
				<input type="text" id="title" name="title" required>
				<label for="introduction">電影簡介：</label>
				<textarea id="introduction" name="introduction" rows="10" cols="50" required></textarea>
				<label for="length">電影長度（分鐘）：</label>
				<input type="number" min="1" max="10000" step="1" id="length" name="length" required>
				<label for="rating">評分（1～5）：</label>
				<input type="number" min="1" max="5" step="1" id="rating" name="rating" required>
			</div>
			<div class="my-column">
				...
				<input type="number" min="0" max="10000" step="10" id="price" name="price" required>
				<label for="on-date">上映日期（含）：</label>
				<input type="date" id="on-date" name="on-date" required>
