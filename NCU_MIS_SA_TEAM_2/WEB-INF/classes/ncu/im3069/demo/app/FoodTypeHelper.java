...
public class FoodTypeHelper extends Helper {
	
	private static FoodTypeHelper helper = null;

	private FoodTypeHelper() {

	}

	public static FoodTypeHelper getHelper() {
		/** Singleton檢查是否已經有Helper物件，若無則new一個，若有則直接回傳 */
		if (helper == null)
			helper = new FoodTypeHelper();
		return helper;
	}
