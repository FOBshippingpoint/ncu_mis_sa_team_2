...
public class OrderHelperOld {
    
    private static OrderHelperOld oh;
    private Connection conn = null;
    private PreparedStatement pres = null;
    private OrderItemHelper oph =  OrderItemHelper.getHelper();
    
    private OrderHelperOld() {
    }
    
    public static OrderHelperOld getHelper() {
        if(oh == null) oh = new OrderHelperOld();
        
        return oh;
    }
    
    public JSONObject create(OrderOld order) {
        /** 記錄實際執行之SQL指令 */
        String exexcute_sql = "";
        long id = -1;
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                o = new OrderOld(id, first_name, last_name, email, address, phone, create, modify);
